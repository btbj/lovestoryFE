  ...
  <div>
    <div class="work-content">
     ...
     <div class="option-btn">
      <div class="btn" style="margin-left: 120px">保存并继续</div>
...
export default {
  data () {
    return {
      ...
      options: {
        profession: ['请选择', '在校学生', '计算机/互联网/IT', '电子/半导体/仪表仪器', '通信技术', '销售',
        ...
        industry: ['请选择', '计算机(软件、硬件、服务)', '通信、电信', '互联网', '电子(半导体、仪器、自动化)',
        ...
        company: ['请选择', '政府机关', '事业单位', '外企企业', '世界500强', '上市公司', '国有企业',
          '私营企业', '自有公司'],
        welfare: ['请选择', '福利优越', '奖金丰厚', '事业稳定上升', '事业刚起步', '投资高回报'],
        status: ['请选择', '轻松稳定', '朝九晚五', '偶尔加班', '经常加班', '偶尔出差', '经常出差',
          '经常有应酬', '工作时间自由'],
        transfer: ['请选择', '完全无可能', '未来几年几乎没可能', '未来几年有可能', '最近即将调动'],
        overseas: ['请选择', '完全无可能', '未来几年几乎没可能', '未来几年有可能', '最近即将调动'],
        business: ['请选择', '一切以家庭为重', '会为家庭牺牲事业', '尽量均衡事业与家庭', '会为事业牺牲家庭利益', '事业第一'],
        school: '',
        major: ['请选择', '计算机类', '电子信息类', '中文类', '外文类', '经济学类', '金融学类', '管理类',
